...
const SteadingProductService_1 = require("../services/SteadingProductService");
...
const getProductController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const product = yield (0, SteadingProductService_1.getProductService)(req.params.id);
...
const getProductsController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const products = yield (0, SteadingProductService_1.getProductsService)();
        return res.status(201).json({
            products,
        });
    }
...
const getProductsByCategoryController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const products = yield (0, SteadingProductService_1.getProductsByCategoryService)(req.body.filterData);
        return res.status(201).json({
            products,
        });
    }
