...
const AromaticProductRepository_1 = require("../repository/AromaticProductRepository");
const getProductService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const newProduct = yield (0, AromaticProductRepository_1.getProductRepository)(id);
    return newProduct;
});
...
const getProductsByCategoryService = (filterData) => __awaiter(void 0, void 0, void 0, function* () {
    const newProducts = yield (0, AromaticProductRepository_1.getProductsByCategoryRepository)(filterData);
    return newProducts;
});
