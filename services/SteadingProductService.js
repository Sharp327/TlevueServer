...
const SteadingProductRepository_1 = require("../repository/SteadingProductRepository");
const getProductService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const newProduct = yield (0, SteadingProductRepository_1.getProductRepository)(id);
    return newProduct;
});
exports.getProductService = getProductService;
const getProductsService = () => __awaiter(void 0, void 0, void 0, function* () {
    const newProducts = yield (0, SteadingProductRepository_1.getProductsRepository)();
    return newProducts;
});
exports.getProductsService = getProductsService;
const getProductsByCategoryService = (filterData) => __awaiter(void 0, void 0, void 0, function* () {
    const newProducts = yield (0, SteadingProductRepository_1.getProductsByCategoryRepository)(filterData);
    return newProducts;
});
